...
\todo[inline]{Web mercator has not been introduced?}
...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Bunny model chunked up using HLOD. Child nodes represent higher resolution representations of the parent models}
    \label{fig:hlod}
\end{figure}
...
\todo[inline]{Do you want us to remove this and the Cracks and Skirts section}
...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Clip maps are smaller than mip maps as only parts of the complete map need to be stored}
