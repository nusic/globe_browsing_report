...
The information needed to locate a tile in a tiled map dataset is the $level$ and a $x-$ and $y$ coordinate within that level. The number of indices in the $x-$ and $y$ dimension will increase by a factor of two for each level.
