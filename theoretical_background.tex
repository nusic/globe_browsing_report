...
The techniques implemented to solve the issue is described under implementation \todo{ref here} and differs somewhat from from the methods proposed by Cozzi and Ring, though the basics are derived from the underlying theories.
