...
Equirectangular projections do not require specific ellipsoids to avoid distortions on the mapped globe. The result of the wide usage is that many map providers choose to provide 2D maps defined in this coordinate system.
