...
\begin{enumerate}
    ...
    \item Ability to render height maps and color textures with up to 25 cm per pixel resolution \todo{Something to fix here?}
...
\todo[inline]{define tiles before this}