...
The algorithm used for selecting the highest resolution chunk tile from a simple tile provider is described by the pseudo code in algorithm \ref{lst:getchunktile}.
...
\begin{lstlisting}[
  caption={Ascend to parent} 
  \label{lst:ascendtoparent}
]
