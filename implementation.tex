...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{The required GDAL raster IO parameters. Figure adapted from \cite{mapprojections}}
    \label{fig:gdalio}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        ...
        \caption{Parent 2.}
    \end{subfigure}
    \caption{Only the highlighted subset of the parent tiles are used for rendering the chunk. Figure from \cite{imageryworld2d}}
