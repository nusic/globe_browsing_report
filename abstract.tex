...
Based on objectives and delimitations, the software was developed to handle out-of-core rendering of multiple data mapped on virtual globes around our solar system. Challenges such as precision, accuracy, curvature and massive datasets were considered and the result is a globe visualization software using a chunked level of detail approach to rendering. The software can render texture layers of various sorts to aid in scientific visualization on top of height mapped grids which gives accurate results rendered at interactive frame rates.
