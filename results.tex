...
\begin{figure}[h]
    ...
    \end{subfigure}
    \caption{Culling of chunks at distance based LOD}
    \label{fig:cullingd}
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[bt]{0.4\textwidth}
        ...
        \caption{Frustum and Horizon culling}
    \end{subfigure}
    \caption{Culling of chunks at Area based LOD}
    \label{fig:cullinga}
\end{figure}
...
The benchmark results in Chapter \ref{ch:culld} and \ref{ch:culla} was compared and evaluated in relation to each other. In Figure \ref{fig:lodcomp} the two approaches are compared using both frustum culling and horizon culling.
...
\begin{tikzpicture}
    ...
    \end{axis}
\end{tikzpicture}
\caption{Comparison of Distance based LOD and Area based LOD.}
\label{fig:lodcomp}
\end{figure}
